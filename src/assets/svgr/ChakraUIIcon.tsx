...
const ChakraUIIcon = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" className="css-2dk2qc" viewBox="0 0 257 257">
		<rect width={257} height={257} fill="url(#chakra_svg_grad)" rx={128.5} />
		<path
			fill="#fff"
		...
		/>
		<defs>
			<linearGradient id="chakra_svg_grad" x1={128.5} x2={128.5} y2={257} gradientUnits="userSpaceOnUse">
