...
const Hero = () => {
	return (
		<section className="min-h-screen flex flex-col w-full max-w-screen-xl mx-auto pt-[4.5rem] relative overflow-hidden z-0 ">
			<Image
			...
			<div className="absolute left-0 w-[min(540px,100%)] h-full bg-gradient-to-r from-slate-900/90 from-60% to-transparent"></div>
